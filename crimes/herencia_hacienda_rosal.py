...
def crear_kb() -> KnowledgeBase:
    ...
    kb.add_fact(Predicate("pierde_con_cambio_testamento", (abogado_restrepo,)))

    kb.add_fact(Predicate("hereda_actualmente", (sobrino_esteban,)))
    kb.add_fact(Predicate("pierde_con_cambio_testamento", (sobrino_esteban,)))

    kb.add_fact(Predicate("gana_con_nuevo_testamento", (secretaria_luna,)))
    ...
    kb.add_rule(
        Rule(
            ...
            body=(
                ...
                Predicate("pierde_con_cambio_testamento", (x,)),
            ),
        )
    )
